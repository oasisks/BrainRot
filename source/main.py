...
if __name__ == '__main__':
    ...
    message = "$200 gift éóñ !! card. I need a new you. This is a new test!"
    collection = "Reddit"
    ...
    try:
        #clip, id = videoMaker.makeVideo("", None, "hot", 10, "https://www.reddit.com/r/amiwrong/comments/1boff73/my_girlfriend_cheated_on_me_with_my_brother_and/")
        clip, id = videoMaker.makeVideo(title, message, "upload")
